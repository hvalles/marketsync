...
4. Información a recopilar Previamente.
   ...
   2. Revise las categorías a utilizar, no se llene de información que no agregue valor a su proceso.
...
#### Puede ver como se realizan las llamadas, header y resultados en la siguiente página
- [Playground](https://sandbox.marketsync.mx/playground/index)
